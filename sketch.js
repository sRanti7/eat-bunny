...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   ballon.position(270,350);
   ballon.size(100,100);
   ballon.mouseClicked(air1);
  ...
  star_display.addAnimation("empty",starempty);
  star_display.scale = 0.3;
  star_display.addAnimation("one",star1);
  star_display.addAnimation("two",star2);
  star_display.changeAnimation("empty");
  star_1 = createSprite(350,50,20,20);
  star_1.addImage(starimage);
  star_1.scale = 0.03;
  star_2= createSprite(100,350,20,20);
  star_2.addImage(starimage);
  star_2.scale = 0.03;
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
    ...
    fruit=null;
     ...
     if(collide(fruit,star_1,10,)==true){
       star_1.visible=false;
       star_display.changeAnimation("one")
       
      }
      if(collide(fruit,star_2,10,)==true){
